...
function Work({ imgSrc, header, subHeader, technologies }: WorkType) {
  return (
    <div className="my-9 work-item rounded-lg relative shadow-xl h-[620px] bg-[#424242]">
      <div>
        <img
        ...
        <div className="p-[28px]">
          ...
          <p className="text-white text-[21px] font-[600] mt-3">{subHeader}</p>
          ...
          <ul className=" flex space-x-6 text-[21px] mt-3 min-w-fit  flex-wrap">
            {technologies.map((tech, index) => (
              <li className=" text-white font-[600] " key={index}>
                {tech}
              </li>
            ))}
          </ul>
